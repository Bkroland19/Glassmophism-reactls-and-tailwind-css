        ...
        bg-opacity-20 h-80 rounded-md shadow-md card"
				>
					...
					<h1 className="col-span-2 text-2xl font-semibold">
						{cardDetails.account_holder}
					</h1>
					<p className="col-span-2 text-gray-800 font-medium">
						{cardDetails.card_number}
					</p>
					<p>
						<span className="text-xs text-gray-700">EXP DATE</span>{" "}
						{cardDetails.exp_month}/{cardDetails.exp_year}
					</p>
					<img
						src="https://png2.cleanpng.com/sh/374afa6ac89d40450e1a0e44b568f01c/L0KzQYm3VMA0N5J3j5H0aYP2gLBuTf1ie6VqitVqcnSwc8PshPl1NZRmitY2dnn2cX73gglubZ95ReVucobsc7a0jfF0fJZ3e9N7ZD24cbS6hvFmP2IAfKJsNj67Qoe4VsQ0OGI6SqQCOUO0SYK4UMU5NqFzf3==/kisspng-mastercard-credit-card-visa-payment-service-mastercard-5ac3fae719d0c6.8261643015227931911058.png"
